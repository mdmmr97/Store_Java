...
public class ItemSpecification extends EntitySpecification<Item> implements Specification {

    public ItemSpecification (List<SearchCriteria> criteria) {this.criteria = criteria;}
